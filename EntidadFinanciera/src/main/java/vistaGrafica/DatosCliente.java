...
public class DatosCliente extends javax.swing.JFrame {
     ...
     */
    Cliente cli;
    public DatosCliente(Cliente cli) {
        initComponents();
        this.cli = cli;
        jLabelNombre.setText(cli.getNombre());
        jLabelApellido.setText(cli.getApellido());
        jLabelCorreo.setText(cli.getCorreo());
        jLabelCedula.setText(Integer.toString(cli.getCedula()));
        jLabelDireccion.setText(cli.getDireccion());
        jLabelTelefono.setText(Long.toString(cli.getTelefono()));
        ...
        jToggleButton1.addItemListener(new ItemListener(){
            ...
            public void itemStateChanged(ItemEvent itemEvent) {
                ...
                if(estado == ItemEvent.SELECTED){
                    jLabelContrasena.setText(cli.getContrasena());
                } else {
                    jLabelContrasena.setText("******");
                }
            }
