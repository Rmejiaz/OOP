 ...
 * @author rafael
 */
public class TransferenciasCajero extends javax.swing.JFrame {
    ...
    public TransferenciasCajero(Cajero caj) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextFieldCedulaDestino = new javax.swing.JTextField();
        ...
        jTextFieldCedulaOrigen = new javax.swing.JTextField();
        ...
        jComboBoxOrigen.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ahorros", "Corriente" }));

        jTextFieldIdDestino.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N

        jTextFieldCedulaDestino.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
        jTextFieldCedulaDestino.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldCedulaDestinoActionPerformed(evt);
            }
        });
        ...
        jLabel7.setText("Datos Cuenta Origen");
        ...
        jLabel10.setText("Cédula del Titular:");

        jTextFieldCuentaOrigen.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N

        jTextFieldCedulaOrigen.setFont(new java.awt.Font("sansserif", 0, 18)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jTextFieldCedulaDestino)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jTextFieldCuentaOrigen)
                                    .addComponent(jTextFieldCedulaOrigen)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(jTextFieldCedulaDestino, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(45, 45, 45)
                .addComponent(jLabel7)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel10)
                            .addComponent(jTextFieldCedulaOrigen, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private Object getSelectedAccountOrigen(){
        
        String tipo = (String)jComboBoxOrigen.getSelectedItem();
        String idCuenta = jTextFieldCuentaOrigen.getText();
        int cedulaTitular = Integer.parseInt(jTextFieldCedulaOrigen.getText());
    ...
    private Object getSelectedAccountDestino(){
        
        String tipo = (String)jComboBoxTipoDestino.getSelectedItem();
        String idCuenta = jTextFieldIdDestino.getText();
        int cedulaTitular = Integer.parseInt(jTextFieldCedulaDestino.getText());
    ...
    private void jButtonTransferirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonTransferirActionPerformed
        ...
        int cedulaTitularDestino = Integer.parseInt(jTextFieldCedulaDestino.getText());
        int cedulaTitularOrigen = Integer.parseInt(jTextFieldCedulaOrigen.getText());
        
        String tipoOrigen = (String)jComboBoxOrigen.getSelectedItem();
        String tipoDestino = (String)jComboBoxTipoDestino.getSelectedItem();
        String idCuentaOrigen = jTextFieldCuentaOrigen.getText();
        String idCuentaDestino = jTextFieldIdDestino.getText();
        
        // Se verifica que la cedula del titular origen si corresponda:
        
        if(tipoOrigen.equals("Ahorros")){
            CuentaAhorros cuenta;
            cuenta = (CuentaAhorros)getSelectedAccountOrigen();
            if(cuenta.getIdCliente() != cedulaTitularOrigen){
                JOptionPane.showMessageDialog(null, "No se encontró la cuenta origen");
                return;
            }
        }
        else{
            CuentaCorriente cuenta;
            cuenta = (CuentaCorriente)getSelectedAccountOrigen();
            if(cuenta.getIdCliente() != cedulaTitularOrigen){
                JOptionPane.showMessageDialog(null, "No se encontró la cuenta origen");
                return;
            }
        ...
        // Ahora lo mismo para la cuenta destino:
        
        
        if(tipoDestino.equals("Ahorros")){
            CuentaAhorros cuenta;
            cuenta = (CuentaAhorros)getSelectedAccountDestino();
            if(cuenta.getIdCliente() != cedulaTitularDestino){
            ...
            CuentaCorriente cuenta;
            cuenta = (CuentaCorriente)getSelectedAccountDestino();
            if(cuenta.getIdCliente() != cedulaTitularDestino){
                JOptionPane.showMessageDialog(null, "No se encontró la cuenta destino");
                return;
            }
        ...
        ValidarMonto.verificar(monto); // se valida el monto ingresado (tiene que ser positivo)
        float saldo;
        saldo = 0;
        if(tipoOrigen.equals("Ahorros")){
            CuentaAhorros cuenta = (CuentaAhorros)getSelectedAccountOrigen();
            saldo = cuenta.getSaldoCuentaAhorros();
        }
        if(tipoOrigen.equals("Corriente")){
            CuentaCorriente cuenta = (CuentaCorriente)getSelectedAccountOrigen();
            saldo = cuenta.getSaldoCuentaCorriente();
        }
        
        if(monto > saldo){
            JOptionPane.showMessageDialog(null, " La cuenta no dispone de fondos suficientes para realizar esta transacción. El saldo es: "+saldo);
            return;
        }
        ...
        if(tipoDestino.equals("Ahorros")){
            if(!contrAho.existeCuenta(idCuentaDestino)){
                ...
                if(cedulaTitularDestino != cuenta_destino.getIdCliente()){
    ...
    private void jTextFieldCedulaDestinoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldCedulaDestinoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldCedulaDestinoActionPerformed
    ...
    private void jTextFieldMontoFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextFieldMontoFocusGained
        ...
        // Mostrar el total disponible en la cuenta:
        
        
        if(jComboBoxOrigen.getSelectedItem().equals("Ahorros")){
            CuentaAhorros cuenta = (CuentaAhorros)getSelectedAccountOrigen();
            jLabelTotal.setText("Disponible: "+cuenta.getSaldoCuentaAhorros());
        }
        else{
            CuentaCorriente cuenta = (CuentaCorriente)getSelectedAccountDestino();
...
//    }
    ...
    private javax.swing.JTextField jTextFieldCedulaDestino;
    private javax.swing.JTextField jTextFieldCedulaOrigen;
